"""
OpenAI Chat Completions API route handler — POST /v1/chat/completions.

Parses the incoming OpenAI-format request body via the Format Detector,
...
from backend.src.format_detector import parse_openai_request


async def handle_openai_chat_completions(request: Request) -> dict:
    """Handle POST /v1/chat/completions — parse and acknowledge an OpenAI request.
